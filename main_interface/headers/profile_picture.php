    <div class="row">
      <div class="col-md-2">
		...
		<hr>
		<a class="btn btn-success" href="change_pic.php"><i class="fas fa-images"></i> Change Profile Picture</a>
      </div>
		<div class="col-md-5">
			<hr>
			<p>Personal Info</p>
      ...
      <div class="col-md-5">
			<form  id="upload_image"  class="form-horizontal" method="POST" enctype="multipart/form-data">
				<div class="control-group">
					<label class="control-label" for="input01"><i class="fas fa-images"></i> Image:</label>
					<div class="controls">
				...
				<div class="control-group">
					<div class="controls">
						<button type="submit" name="submit" class="btn btn-success"><i class="fas fa-upload"></i> Upload</button>
					</div>
				</div>
			</form>
							<?php
