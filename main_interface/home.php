...
<?php include('session.php'); ?>    
	...
	<?php include('navbar.php'); ?>
			<div id="masthead">  
				<div class="container">
					<!-- heading which will be stored in a container-->
      ...
      <div class="panel">
        <div class="panel-body">
          ...
          <div class="row">    
            ...
            <!-- command to fetch data to print-->
				<?php
		...
		<!-- Printed data from databse-->
            ...
            <div class="col-md-10 col-sm-9">
              ...
              <div class="row">
                ...
                <div class="col-xs-3"><a href="delete_post.php<?php echo '?id='.$id; ?>" class="btn btn-danger"><i class="far fa-trash-alt"></i> Delete</a></div>
              </div>
              <br><br>
            </div>
	<?php } ?>		
